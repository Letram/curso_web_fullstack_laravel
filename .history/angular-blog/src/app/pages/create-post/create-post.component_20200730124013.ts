...
export class CreatePostComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._activatedRoute.params.subscribe(
      async params => {
        ...
        if(post == null){
          post = await this._postService.getPostAsPromise(+params.id);
          console.log(post);
        }
  ...
  public editPost(){
    let modPost = {id: this._postId, category_id: this.postCategory, title: this.postTitle, content: this.postContent, image_url: this.postImage_url};
    console.log(modPost);
